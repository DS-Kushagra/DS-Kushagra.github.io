  ...
  return (
    <div className="pb-20 pt-36">
      ...
      z-10'>
        ...
        lg:max-w-[60vw] flex-col items-center justify-center'>
            <h2 className='uppercase tracking-widest
            text-xs text-center text-blue-100 max-w-90'>
                Dynamic Data Scientist Portfolio
            </h2>

            <TextGenerateEffect
             className='text-center text-[40px] md:text-4xl
             lg:text-6xl'
             words='Transforming Data into Seamless Analysis'
            />
            <p className='text-center md:tracking-wider mb-4
             text-sm md:text-lg lg:text-2xl'>
                Hi, I&apos;m Kushagra,the next Data Scientist

            </p>

            <a href='#about'>
                <MagicButton
                title = "Have a look on my work"
